  ...
  const handleRatingSubmit = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        try {
          const apiEndpoint = activeTab === "stable" 
            ? `/api/bookingStables/${selectedBooking._id}`
            : `/api/bookingTrainers/${selectedBooking._id}`;
            
          const bookingUpdateResponse = await putRequest(apiEndpoint, {
